...
class MazeGame:
    ...
    def load_animation_frames(self, folder_path):
        ...
        for file_name in sorted(os.listdir(folder_path)):
            if file_name.endswith(".png"):
                ...
                resized_image = image.resize((self.cell_size+10, self.cell_size+20), Image.Resampling.LANCZOS)
    ...
    def animate_player(self, direction):
        ...
        for frame in frames:
            ...
            self.root.update()
            self.root.after(50)  # Delay between frames
